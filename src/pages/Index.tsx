...
const services = [
  { zone: "Подмышки", time: "20 мин", price: "800 ₽", popular: false },
  { zone: "Бикини глубокое", time: "30 мин", price: "2 200 ₽", popular: true },
  { zone: "Ноги полностью", time: "50 мин", price: "3 500 ₽", popular: false },
  { zone: "Руки полностью", time: "40 мин", price: "2 500 ₽", popular: false },
  { zone: "Верхняя губа", time: "15 мин", price: "600 ₽", popular: false },
  { zone: "Живот", time: "20 мин", price: "1 200 ₽", popular: false },
  { zone: "Лицо", time: "25 мин", price: "1 800 ₽", popular: false },
  { zone: "Спина", time: "35 мин", price: "2 800 ₽", popular: false },
];

const team = [
  { name: "Алина", role: "Старший мастер", exp: "4 года опыта", edu: "Мед. образование", emoji: "👩‍⚕️" },
  { name: "Карина", role: "Мастер эпиляции", exp: "3 года опыта", edu: "Мед. образование", emoji: "💁‍♀️" },
  { name: "Диана", role: "Мастер эпиляции", exp: "2 года опыта", edu: "Мед. образование", emoji: "🧖‍♀️" },
];

const perks = [
  { icon: "🎁", title: "Маска Darling", desc: "Дарим розовую маску Darling за каждый оставленный отзыв" },
...
const reviews = [
  ...
  { name: "Катя Л.", age: "21 год", text: "Записалась онлайн — супер удобно. Пришла, конфетки, маска в подарок за отзыв, мастер объяснила всё про уход. Вернусь точно!", rating: 5 },
];
